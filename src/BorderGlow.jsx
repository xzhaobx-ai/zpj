...
const BorderGlow = ({
  ...
  return (
    <div
      ...
      onFocusCapture={() => cardRef.current?.style.setProperty('--edge-proximity', '100')}
      onBlurCapture={e => { if (!e.currentTarget.contains(e.relatedTarget)) cardRef.current?.style.setProperty('--edge-proximity', '0'); }}
